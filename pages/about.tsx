  ...
  return (
    <DefaultLayout>
      ...
      <section className="text-lg px-8 py-8 flex flex-col gap-3">
        <p>
          The information presented on this site is derived from the
          ASPCA&apos;s “Toxic and Non-Toxic Plants” list available at
        ...
        <p>
          ...
          Spain&apos;s Intellectual Property Law; and as a non-commercial
          extraction under the EU Database Directive (96/9/EC) and the EU
          Digital Single Market Directive&apos;s text-and-data-mining
          exceptions.
        </p>
        <p>
